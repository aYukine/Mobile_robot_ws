...
class OdometryNode(Node):
    def __init__(self):
        ...
        self.a = math.sqrt(2) * self.r / 4.0
        self.b = self.r / ( 4 * self.l)
    ...
    def callback(self):
        self.Vx = self.a * (self.wheelspeed[0] + self.wheelspeed[1] + self.wheelspeed[2] + self.wheelspeed[3])
        self.Vy = self.a * (-self.wheelspeed[0] + self.wheelspeed[1] -self.wheelspeed[2] + self.wheelspeed[3])
        self.Wz = self.b * (-self.wheelspeed[0] + self.wheelspeed[1] + self.wheelspeed[2] - self.wheelspeed[3])
